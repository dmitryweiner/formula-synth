// Пользовательские пресеты в localStorage. Ключ намеренно старый
// (formula_audio_lab_*) — чтобы пресеты, сохранённые в прежней версии
// приложения, не потерялись.
import type { AppState } from './schema';

export const USER_PRESETS_KEY = 'formula_audio_lab_user_presets_v1';
